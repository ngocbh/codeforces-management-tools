...
create_dir(os.path.join(WORKING_DIR,'a'))
...
def get_standings_url(contestID, groupID=GROUP_ID):
	return STANDINGS_URL.format(groupID, contestID)

def get_status_url(contestID, groupID=GROUP_ID):
	return STATUS_URL.format(groupID, contestID)
